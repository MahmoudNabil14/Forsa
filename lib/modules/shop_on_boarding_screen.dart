...
class OnBoardingScreen extends StatelessWidget {
  ...
  List<onBoardingModel> boarding = [
    onBoardingModel(
        'onBoarding 1', 'assets/images/on_boarding.png', 'boooooooooooody 1'),
    onBoardingModel(
        'onBoarding 2', 'assets/images/on_boarding.png', 'boooooooooooody 2'),
    onBoardingModel(
        'onBoarding 3', 'assets/images/on_boarding.png', 'boooooooooooody 3'),
  ];
